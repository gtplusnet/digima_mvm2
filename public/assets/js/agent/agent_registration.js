$(document).ready(function(){
	...
	$('#continue').click(function(){
		...
		else
		{
			$.ajax({
				method: 'POST',
				url: '/agent/register_business',
				data: {business_name: business_name, city_list: city_list, business_address: business_address, primary_business_phone: primary_business_phone, secondary_business_phone: secondary_business_phone, prefix: prefix, first_name: first_name, last_name: last_name, email: email},
				success:function(data){
