...
<div class="page-sidebar sidebar">
    <div class="page-sidebar-inner slimscroll">
        <ul class="menu accordion-menu">
        	...
        	<li style="display:none;" class="mob-logout"><a href="/supervisor/logout" class="waves-effect waves-button"><span class="menu-icon fa fa-sign-out"></span><p>Sign Out</p></a></li>	
        </ul>
    </div>
</div>