            ...
            <div class="row">
                <div class="col-md-3 profile-image">
                    <div class="profile-image-container">
                         <img src="{{$supervisor_info->user_profile}}" alt="" style="min-width: 200px;min-height: 200px;max-height: 200px;max-width: 200px;">
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="panel-body" id="showProfile">
                                ...
                                <form class="form-horizontal">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control input-rounded" id="input-rounded" value="{{$supervisor_info->user_first_name}}" readonly>
                                        </div>
                                        <label for="input-Default" class="col-sm-2 control-label">Last Name</label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control input-rounded" id="input-rounded" value="{{$supervisor_info->user_last_name}}" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="input-Default" class="col-sm-2 control-label">Primary Phone</label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control input-rounded" id="input-rounded" value="{{$supervisor_info->user_phone_number}}" readonly>
                                        </div>
                                        <label for="input-Default" class="col-sm-2 control-label">Email</label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control input-rounded" id="input-rounded" value="{{$supervisor_info->user_email}}" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control input-rounded" id="input-rounded" value="{{$supervisor_info->user_gender}}" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="input-Default" class="col-sm-2 control-label">Address</label>
                                        <div class="col-sm-10">
                                            <textarea class="form-control input-rounded" placeholder="" rows="4=6" readonly>{{$supervisor_info->user_address}}</textarea>
                                        </div>
                                    </div>
...
<script src="/assets/supervisor/supervisor_profile.js"></script>
@endsection