<div class="page-sidebar sidebar">
    ...
    <div class="page-sidebar-inner slimscroll">
       <ul class="menu accordion-menu">
            ...
            <li class="{{ (Request::segment(2) == 'add') ? 'active' : ''  }}"><a href="/agent/add/client" class="waves-effect waves-button"><span class="menu-icon fa fa-user-plus"></span><p>ADD MERCHANT</p></a></li>
