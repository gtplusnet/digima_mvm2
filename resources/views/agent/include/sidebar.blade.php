    ...
    <div class="page-sidebar-inner slimscroll">
       {{--  <div class="sidebar-header">
        ...
        <ul class="menu accordion-menu">
            <li class="{{ (Request::segment(2)=='') ? 'active' : ''  }}"><a href="/agent" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-home"></span><p>Dashboard</p></a></li>
            ...
            <li class="{{ (Request::segment(2) == 'add_client') ? 'active' : ''  }}"><a href="/agent/add_client" class="waves-effect waves-button"><span class="menu-icon fa fa-user-plus"></span><p>Add Client</p></a></li>
        </ul>
