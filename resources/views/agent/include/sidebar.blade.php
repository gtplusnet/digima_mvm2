    ...
    <div class="page-sidebar-inner slimscroll">
       {{--  <div class="sidebar-header">
        ...
        <ul class="menu accordion-menu">
            ...
            <li class="{{ (Request::segment(2) == 'client') ? 'active' : ''  }}"><a href="/agent/client" class="waves-effect waves-button"><span class="menu-icon fa fa-group"></span><p>asdasdasdasdasd</p></a></li>
