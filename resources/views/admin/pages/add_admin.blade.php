	    ...
	    <div class="row">
	        <div class="panel panel-primary">
	            <div class="panel-heading clearfix">
	                <h3 class="panel-title" style="color: white;">ADMIN</h3>
	            </div>
				...
				@endif
	                <form class="form-horizontal" method="post" action="/admin/add_admin_submit">
	                	{{csrf_field()}}
	                    ...
	                    <div class="form-group">
	                        ...
	                        <div class="col-sm-3">
	                            <button  class="btn btn-primary btn-lg" style="border-radius: 20px; float: right;">ADD ADMIN</button>
	                        </div>
	                </form>
	            </div>
	        </div>
