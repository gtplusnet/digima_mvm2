<div class="page-sidebar sidebar">
    <div class="page-sidebar-inner slimscroll">
        <ul class="menu accordion-menu">
          ...
          <!--   <li class="{{ (Request::segment(2) == 'inquiries') ? 'active' : ''  }}"><a href="/merchant/inquiries" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-envelope"></span><p>Business Inquiries</p></a></li> -->
