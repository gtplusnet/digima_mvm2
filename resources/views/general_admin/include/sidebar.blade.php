 <div class="page-sidebar sidebar">
    <div class="page-sidebar-inner slimscroll">
        <ul class="menu accordion-menu">
            ...
            <li class="{{ (Request::segment(2)=='email_invoice') ? 'active' : ''  }}"><a href="/general_admin/email_invoice" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-envelope"></span><p>Emailing Invoice</p></a></li>
            ...
            <li class="{{ (Request::segment(2)=='manage_user') ? 'active' : ''  }}"><a href="/general_admin/manage_user" class="waves-effect waves-button"><span class="menu-icon fa fa-user-plus"></span><p>Manage Team/Agent</p></a></li>
