...
<div class="tab-content" >
	...
	<div style="margin-top: 150px;" class="modal fade deleteModal"    id="deleteModal" role="dialog">
	...
	<div class="modal fade" id="subSubCategory" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-md" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<p class="modal-title" id="cat_name_head_sub" style="font-size:25px;font-weight:  bold;"></p>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
					</button>
				</div>
				<div class="modal-body">
					<div class="pull-left" style="margin:20px 0px 20px 20px">
						<button type="button"  id="addSubSubCategoryBtn"  class="btn btn-success" ><i class="fa fa-plus-circle"></i>&nbsp;&nbsp;Add New</button>
					</div>
					<div id="get_sub_sub_category_result">
	...
	<div style="margin-top:80px;" class="modal fade" id="deleteModal_sub" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-sm" role="document">
			<div class="modal-content">
				<div class="modal-body" style="margin-bottom:30%;">
					...
					<div class="col-sm-12">
						<center>
						<input type="hidden" id="delete_id_sub" value=""/>
						<input type="hidden" id="delete_link_sub" value=""/>
						<button type="button" class=" btn btn-danger" id="actionDelete_sub">Delete</button>
						<button type="button" class="btn btn-default"  data-dismiss="modal">Cancel</button>
						</center>
					</div>
				</div>
		...
		<div class="modal-dialog modal-md">
			<div class="modal-content">
				...
				<div class="modal-body" style="margin-bottom: 150px;" >
					...
					<div class="col-sm-12">
						<div class="form-group col-md-3">
							<label for="business_name" >Sub-Category Name</label>
						</div>
						<div class="form-group col-md-9">
					...
					<div class="col-sm-12">
						<div class="form-group col-md-3">
							<label for="business_name" >Sub-Category Information</label>
						</div>
						<div class="form-group col-md-9">
	...
	<div style="margin-top: 150px;" class="modal fade" id="addSubSubCategory" role="dialog">
		<div class="modal-dialog modal-md">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" onClick="window.location.reload();" data-dismiss="modal">&times;</button>
				...
				<div id="addSubSubCategory_alert">
				<div class="modal-body" style="margin-bottom: 165px;" >
					
					
					<div class="col-sm-12">
						<div class="form-group col-md-3">
							<label for="business_name" >Sub Sub-Category Name</label>
						</div>
						<div class="form-group col-md-9">
							<input type="text" class="form-control" name="cat_name_dis_sub" id="cat_name_dis_sub"  style="width:100%;margin-bottom: 20px;"/>
							<input type="hidden"  name="cat_id_dis_sub" id="cat_id_dis_sub"/>
						</div>
					</div>
					<div class="col-sm-12">
						<div class="form-group col-md-3">
							<label for="business_name" >Sub Sub-Category Information</label>
						</div>
						<div class="form-group col-md-9">
							<input type="text" class="form-control" name="cat_info_dis_sub" id="cat_info_dis_sub" style="width:100%"/>
						</div>
					</div>

					<div class="col-sm-12">
						<center>
						<button type="submit" class="save_sub_sub_categoryBtn btn btn-primary" name="save_sub_sub_categoryBtn" id="save_sub_sub_categoryBtn">Add Sub-Category</button>
						<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
						</center>
					</div>
					</div>
