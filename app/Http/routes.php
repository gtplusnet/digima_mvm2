...
Route::post('/supervisor/add_team_submit', 	'SupervisorController@add_team_submit');
Route::post('/supervisor/add_agent_submit', 	'SupervisorController@add_agent_submit');
